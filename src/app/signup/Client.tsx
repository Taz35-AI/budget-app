      ...
      <div className="min-h-screen bg-[#F4FDFB] flex flex-col items-center justify-center px-4">
        <div className="w-full max-w-sm text-center">
          ...
          <p className="text-sm text-slate-500 mb-6">
            We sent a confirmation link to <span className="text-slate-700 font-medium">{email}</span>. Click it to activate your account.
          </p>
          <Link href="/login" className="text-sm text-slate-500 hover:text-slate-700 underline active:opacity-70 transition-all duration-100">
            Back to sign in
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#F4FDFB] flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <p className="text-center text-sm text-slate-400 mt-4">
          ...
          <Link href="/login" className="text-slate-600 hover:text-slate-900 underline transition-colors">
            Sign in
          </Link>
        </p>

      ...
      <div style={{ background: '#0A1A1A', color: 'rgba(255,255,255,0.80)', ...sans, minHeight: '100vh' }}>
        ...
        <article style={{ maxWidth: 720, margin: '0 auto', padding: '60px 24px 100px' }}>
          ...
          <nav aria-label="breadcrumb" style={{ marginBottom: 36 }}>
            <ol style={{ display: 'flex', gap: 8, fontSize: 13, color: 'rgba(255,255,255,0.35)', listStyle: 'none', padding: 0, margin: 0, alignItems: 'center' }}>
              <li><Link href="/" style={{ color: 'rgba(255,255,255,0.35)', textDecoration: 'none' }}>Home</Link></li>
              <li style={{ opacity: 0.4 }}>/</li>
              <li><Link href="/blog" style={{ color: 'rgba(255,255,255,0.35)', textDecoration: 'none' }}>Blog</Link></li>
              <li style={{ opacity: 0.4 }}>/</li>
              <li style={{ color: 'rgba(255,255,255,0.55)' }}>Stop guessing where your money goes</li>
            </ol>
          </nav>

          {/* Category + date */}
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
            <span style={{ fontSize: 12, fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#4E9E9B', background: 'rgba(59,122,120,0.12)', border: '1px solid rgba(59,122,120,0.3)', borderRadius: 100, padding: '3px 10px' }}>Personal Finance</span>
            <time dateTime="2026-04-02" style={{ fontSize: 13, color: 'rgba(255,255,255,0.35)' }}>April 2, 2026</time>
            <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.25)' }}>15 min read</span>
          </div>

          {/* Title */}
          <h1 style={{ ...serif, fontSize: 'clamp(32px, 5vw, 52px)', fontWeight: 400, color: '#fff', lineHeight: 1.1, letterSpacing: -0.5, marginBottom: 20 }}>
            Stop Guessing Where Your Money Goes and Start Building Wealth
          </h1>

          <p style={{ fontSize: 19, color: 'rgba(255,255,255,0.55)', lineHeight: 1.6, marginBottom: 48, fontWeight: 300 }}>
          ...
          <div style={{ fontSize: 16, lineHeight: 1.8, color: 'rgba(255,255,255,0.72)' }}>
            ...
            <h2 style={{ ...serif, fontSize: 28, fontWeight: 400, color: '#fff', marginBottom: 16, marginTop: 48 }}>
            ...
            <div style={{ background: 'rgba(59,122,120,0.10)', border: '1px solid rgba(59,122,120,0.25)', borderRadius: 12, padding: '20px 24px', margin: '32px 0' }}>
              <p style={{ margin: 0, color: 'rgba(255,255,255,0.75)', fontStyle: 'italic' }}>
            ...
            <h3 style={{ fontSize: 18, fontWeight: 600, color: '#fff', marginBottom: 12, marginTop: 32 }}>The categories worth examining closely</h3>
            <ul style={{ paddingLeft: 20, display: 'flex', flexDirection: 'column', gap: 10 }}>
              <li><strong style={{ color: '#fff' }}>Subscriptions.</strong> Go through your bank statement and highlight every recurring charge. Not just Netflix and Spotify. Software tools, cloud storage, news sites, fitness apps, delivery passes, insurance add-ons you forgot about. Most people find two to five subscriptions they had genuinely forgotten were running.</li>
              <li><strong style={{ color: '#fff' }}>Food and drink outside the home.</strong> This is the category that almost always shocks people. Coffees, lunches, quick dinners, delivery apps. Add them up. For many people this is 300 to 600 a month without feeling like they eat particularly extravagantly.</li>
              <li><strong style={{ color: '#fff' }}>Convenience spending.</strong> The taxis you took instead of waiting for the bus. The ready meals you bought because you were tired. The things you bought at the petrol station because you needed them right now. Convenience has a consistent premium attached to it.</li>
              <li><strong style={{ color: '#fff' }}>One-off purchases that happen every month.</strong> There is no such thing as a truly one-off purchase. Something unexpected always comes up. The question is whether you plan for it or react to it.</li>
            </ul>
            ...
            <h3 style={{ fontSize: 18, fontWeight: 600, color: '#fff', marginBottom: 12, marginTop: 32 }}>Step one: stop the bleeding</h3>
            ...
            <h3 style={{ fontSize: 18, fontWeight: 600, color: '#fff', marginBottom: 12, marginTop: 32 }}>Step two: build a floor</h3>
            ...
            <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 12, padding: '24px', margin: '32px 0' }}>
              <p style={{ margin: 0, fontWeight: 600, color: '#fff', marginBottom: 12 }}>A practical order of operations</p>
            ...
            <h3 style={{ fontSize: 18, fontWeight: 600, color: '#fff', marginBottom: 12, marginTop: 32 }}>Step three: actually invest</h3>
            ...
            <h3 style={{ fontSize: 18, fontWeight: 600, color: '#fff', marginBottom: 12, marginTop: 32 }}>What moves net worth upward</h3>
            <ul style={{ paddingLeft: 20, display: 'flex', flexDirection: 'column', gap: 10 }}>
              <li><strong style={{ color: '#fff' }}>Investments growing.</strong> Every month you stay invested, market returns add to the value without you doing anything.</li>
              <li><strong style={{ color: '#fff' }}>Debt shrinking.</strong> Each loan payment reduces what you owe. For a mortgage, even in the early years, some of each payment goes to reducing the balance.</li>
              <li><strong style={{ color: '#fff' }}>Saving regularly.</strong> Cash savings add directly to assets, though they grow slowly compared to investments.</li>
              <li><strong style={{ color: '#fff' }}>Avoiding new consumer debt.</strong> Taking on new debt immediately moves net worth in the wrong direction. Every time you borrow to buy something that depreciates, you make yourself poorer.</li>
            </ul>
            ...
            <div style={{ background: 'rgba(59,122,120,0.10)', border: '1px solid rgba(59,122,120,0.25)', borderRadius: 16, padding: '28px 28px', margin: '40px 0', display: 'flex', flexDirection: 'column', gap: 16 }}>
              <p style={{ margin: 0, fontSize: 18, fontWeight: 600, color: '#fff' }}>See your financial future before it arrives</p>
              <p style={{ margin: 0, fontSize: 15, color: 'rgba(255,255,255,0.6)', lineHeight: 1.6 }}>Spentum shows your projected balance day by day, up to seven years ahead. Spot the gaps, plan around them, and watch your net worth grow in real time. Free during beta, no bank login required.</p>
              <div>
          ...
          {/* TAGS */}
          <div style={{ marginTop: 56, paddingTop: 32, borderTop: '1px solid rgba(255,255,255,0.07)', display: 'flex', flexWrap: 'wrap', gap: 8 }}>
            {['Expense Tracking', 'Building Wealth', 'Investing', 'Net Worth', 'Personal Finance', 'Pay Yourself First', 'Index Funds', 'Financial Independence'].map((tag) => (
              <span key={tag} style={{ fontSize: 13, color: 'rgba(255,255,255,0.45)', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 100, padding: '4px 12px' }}>
                {tag}
              </span>
            ))}
          </div>
          ...
          <div style={{ marginTop: 48 }}>
            <Link href="/blog" style={{ fontSize: 14, color: '#4E9E9B', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 6 }}>

        ...
        <article style={{ maxWidth: 720, margin: '0 auto', padding: '60px 24px 100px' }}>
          ...
          <nav aria-label="breadcrumb" style={{ marginBottom: 36 }}>
            <ol style={{ display: 'flex', gap: 8, fontSize: 13, color: 'rgba(255,255,255,0.35)', listStyle: 'none', padding: 0, margin: 0, alignItems: 'center' }}>
              ...
              <li style={{ opacity: 0.4 }}>/</li>
              <li style={{ color: 'rgba(255,255,255,0.55)' }}>Oil prices, inflation and your budget</li>
            </ol>
          </nav>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
            ...
            <time dateTime="2026-03-31" style={{ fontSize: 13, color: 'rgba(255,255,255,0.35)' }}>March 31, 2026</time>
            <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.25)' }}>14 min read</span>
          </div>
          ...
          <div style={{ fontSize: 16, lineHeight: 1.8, color: 'rgba(255,255,255,0.72)' }}>
            ...
            {/* Tags */}
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginTop: 56, paddingTop: 32, borderTop: '1px solid rgba(255,255,255,0.07)' }}>
              {['Oil Prices', 'Inflation', 'Personal Finance', 'Budgeting', 'Cost of Living', 'Energy Bills', 'Debt'].map((tag) => (
                <span key={tag} style={{ fontSize: 12, color: 'rgba(255,255,255,0.35)', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 100, padding: '4px 12px' }}>
                  {tag}
                </span>
              ))}
            </div>
            ...
            {/* CTA */}
            <div style={{ marginTop: 56, background: 'rgba(59,122,120,0.10)', border: '1px solid rgba(59,122,120,0.25)', borderRadius: 16, padding: '32px 36px' }}>
              <p style={{ ...serif, fontSize: 24, color: '#fff', fontWeight: 400, marginBottom: 12 }}>Know exactly where your money is going</p>

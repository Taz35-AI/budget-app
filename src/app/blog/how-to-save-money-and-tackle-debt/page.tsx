...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://spentum.com/blog/how-to-save-money-and-tackle-debt' },
  openGraph: {
    type: 'article',
    url: 'https://spentum.com/blog/how-to-save-money-and-tackle-debt',
...
const jsonLd = {
  ...
  author: { '@type': 'Organization', name: 'Spentum', url: 'https://spentum.com' },
  publisher: {
    '@type': 'Organization',
    name: 'Spentum',
    logo: { '@type': 'ImageObject', url: 'https://spentum.com/spentum.png' },
  },
  image: 'https://spentum.com/og-image.png',
  mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://spentum.com/blog/how-to-save-money-and-tackle-debt' },
        ...
        <article style={{ maxWidth: 720, margin: '0 auto', padding: '60px 24px 100px' }}>
          ...
          <nav aria-label="breadcrumb" style={{ marginBottom: 36 }}>
            <ol style={{ display: 'flex', gap: 8, fontSize: 13, color: 'rgba(255,255,255,0.35)', listStyle: 'none', padding: 0, margin: 0, alignItems: 'center' }}>
              ...
              <li style={{ opacity: 0.4 }}>/</li>
              <li style={{ color: 'rgba(255,255,255,0.55)' }}>How to save money and tackle debt</li>
            </ol>
          </nav>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
            ...
            <time dateTime="2026-03-30" style={{ fontSize: 13, color: 'rgba(255,255,255,0.35)' }}>March 30, 2026</time>
            <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.25)' }}>12 min read</span>
          </div>
          ...
          <div style={{ fontSize: 16, lineHeight: 1.8, color: 'rgba(255,255,255,0.72)' }}>
            ...
            <h3 style={{ fontSize: 18, fontWeight: 600, color: '#fff', marginBottom: 12, marginTop: 32 }}>A version that works on a tight budget</h3>
            <ul style={{ paddingLeft: 20, display: 'flex', flexDirection: 'column', gap: 8 }}>
              <li><strong style={{ color: '#fff' }}>Needs first.</strong> Housing, groceries, utilities, transport, minimum debt payments. These come out before anything else.</li>
              <li><strong style={{ color: '#fff' }}>Save a fixed amount on payday.</strong> Not what is left at the end of the month. Set up an automatic transfer on the day your pay arrives.</li>
              <li><strong style={{ color: '#fff' }}>Spend what is left.</strong> Whatever remains after needs and savings is yours to use without guilt.</li>
            </ul>
            ...
            <h3 style={{ fontSize: 18, fontWeight: 600, color: '#fff', marginBottom: 12, marginTop: 32 }}>The avalanche method</h3>
            ...
            <h3 style={{ fontSize: 18, fontWeight: 600, color: '#fff', marginBottom: 12, marginTop: 32 }}>The snowball method</h3>
            ...
            <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 12, padding: '24px', margin: '32px 0' }}>
              <p style={{ margin: 0, fontWeight: 600, color: '#fff', marginBottom: 12 }}>Quick example: snowball vs avalanche</p>
            ...
            <h3 style={{ fontSize: 18, fontWeight: 600, color: '#fff', marginBottom: 12, marginTop: 32 }}>Areas worth reviewing</h3>
            <ul style={{ paddingLeft: 20, display: 'flex', flexDirection: 'column', gap: 10 }}>
              <li><strong style={{ color: '#fff' }}>Subscriptions.</strong> Streaming, software, apps, magazines. List them all. Cancel anything you have not used in the past 30 days.</li>
              <li><strong style={{ color: '#fff' }}>Takeaway and food delivery.</strong> Set a realistic weekly limit rather than trying to eliminate it. The limit is more sustainable than a ban.</li>
              <li><strong style={{ color: '#fff' }}>Impulse buys online.</strong> Add to cart, wait 48 hours. If you still want it, you can decide then. Most times you forget about it.</li>
              <li><strong style={{ color: '#fff' }}>Insurance and utilities.</strong> These feel fixed but rarely are. A 20-minute call to your providers once a year can save you hundreds.</li>
              <li><strong style={{ color: '#fff' }}>Unused gym memberships.</strong> Classic. Be honest with yourself about what you actually use.</li>
            </ul>
            ...
            <div style={{ background: 'rgba(59,122,120,0.10)', border: '1px solid rgba(59,122,120,0.25)', borderRadius: 16, padding: '28px 28px', margin: '40px 0', display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <div>
                <Link href="/signup" style={{ display: 'inline-block', background: '#3B7A78', color: '#fff', fontSize: 14, fontWeight: 600, padding: '11px 22px', borderRadius: 10, textDecoration: 'none' }}>
                  Try Spentum free
                </Link>
              </div>
            </div>

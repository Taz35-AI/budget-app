        ...
        <section className="border-y border-white/[0.06] bg-[#122928]/60 py-4">
          <div className="px-4 sm:px-6">
            <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10 text-white/30 text-sm font-medium">
              {['Web app, Android + iOS coming soon', 'No bank connection', 'Dark & light mode', 'Multi-language', 'Data encrypted at rest', 'Free forever for early users'].map((item) => (
          ...
          <div className="px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
              {[
                ...
                { n: '03', title: 'See your future balance', body: 'Instantly see your projected balance day by day, weeks, months and years ahead.' },
              ].map((s) => (

      ...
      <button
        ...
        className={cn(
          'inline-flex items-center justify-center rounded-2xl font-bold tracking-tight transition-all duration-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 active:scale-[0.96] disabled:opacity-40 disabled:cursor-not-allowed select-none',
          {
            ...
            'bg-brand-primary/[0.08] text-brand-primary hover:bg-brand-primary/[0.14] focus-visible:ring-brand-primary/40 dark:bg-brand-primary/[0.12] dark:text-teal-200 dark:hover:bg-brand-primary/20 shadow-[0_1px_3px_rgba(0,0,0,0.06)] active:shadow-[inset_0_1px_3px_rgba(0,0,0,0.1)] border border-brand-primary/[0.12] dark:border-brand-primary/20': variant === 'secondary',

    ...
    <AppLayout>
      ...
      <header className="sticky top-0 z-20 glass-header">
        ...
        <div className="px-4 sm:px-6 h-16 sm:h-14 flex items-center gap-3">
          ...
          <button
            onClick={() => router.back()}
            className="lg:hidden ml-auto flex items-center gap-1.5 h-10 px-4 rounded-2xl bg-slate-100 dark:bg-white/5 border border-brand-primary/[0.08] dark:border-white/[0.08] text-sm font-semibold text-slate-600 dark:text-white/60 hover:bg-slate-200 dark:hover:bg-white/10 hover:text-slate-800 dark:hover:text-white active:scale-[0.96] transition-all duration-100"
          >
      ...
      <div className="px-4 sm:px-6 py-6 grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        {/* ── Profile header ──────────────────────────────────────────── */}
        <div className="lg:col-span-2 glass-card rounded-3xl p-6 flex flex-row items-center gap-5">
          ...
          {showPwForm && (
            <form onSubmit={handleChangePassword} className="flex flex-col gap-3">
              ...
              <input
                ...
                required
                minLength={6}
                className="h-11 rounded-2xl border border-brand-primary/[0.08] dark:border-white/[0.08] bg-white/60 dark:bg-white/[0.04] backdrop-blur-sm px-3 text-sm text-slate-800 dark:text-white placeholder:text-slate-400 dark:placeholder:text-white/25 outline-none focus:border-brand-primary/40 shadow-[inset_0_1px_2px_rgba(0,0,0,0.06)] dark:shadow-[inset_0_1px_2px_rgba(0,0,0,0.2)] transition-all"
              />
              <input
                type="password"
                value={confirmPw}
        ...
        {/* ── Danger zone ─────────────────────────────────────────────── */}
        <div className="glass-card rounded-3xl border-red-200/50 dark:border-red-500/15 p-5">
          ...
          {(deleteStep === 'confirm' || deleteStep === 'deleting') && (
            <div className="flex flex-col gap-3">
              ...
              <input
                ...
                placeholder={email}
                className="h-11 rounded-2xl border border-red-200 dark:border-red-500/30 bg-white/60 dark:bg-white/[0.04] backdrop-blur-sm px-3 text-sm text-slate-800 dark:text-white placeholder:text-slate-400 outline-none focus:border-red-400 shadow-[inset_0_1px_2px_rgba(0,0,0,0.06)] dark:shadow-[inset_0_1px_2px_rgba(0,0,0,0.2)] transition-all"
              />

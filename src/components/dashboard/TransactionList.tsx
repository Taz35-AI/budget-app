...
interface Props {
  ...
  symbol: string;
  onAddNew: () => void;
  onDuplicate?: (tx: DayTransaction) => void;
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-slate-800 dark:text-white/90 break-words">{tx.name === 'Balance Adjustment' ? tc('balanceAdjustment') : tx.name}</p>

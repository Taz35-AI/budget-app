...
function SectionHeader({
  ...
  return (
    ...
    >
      ...
      <p className="text-[10px] font-bold uppercase tracking-[0.1em] text-[#154265]/50 dark:text-[#D1E3EE]/35 flex-1 text-left">
        {label}
      </p>
      {expandable && (
        <svg
          className={cn(
            'w-3 h-3 text-[#154265]/30 dark:text-[#D1E3EE]/25 transition-transform duration-200 flex-shrink-0',
            expanded && 'rotate-180',
          )}
...
const ROW_CLASS = 'flex items-center gap-3 px-3 py-2.5 rounded-xl bg-[#f7fafc] dark:bg-[#154265]/10 border border-[#D1E3EE]/50 dark:border-[#1ECB6C]/[0.07] hover:bg-[#D1E3EE]/30 dark:hover:bg-[#154265]/20 transition-colors';
...
export function MonthSummary({ month, dayTransactions, formatAmount }: Props) {
  ...
  return (
    <div className="flex flex-col gap-5 px-5 py-5">
      ...
      {/* Month heading */}
      <div>
        <h2 className="text-base font-extrabold text-[#154265] dark:text-white tracking-tight leading-tight">
          {format(month, 'MMMM yyyy')}
        </h2>
        <p className="text-[11px] text-[#154265]/40 dark:text-[#D1E3EE]/30 mt-0.5 font-medium">
      ...
      <div className="grid grid-cols-3 gap-2">
        {/* Daily avg */}
        <div className="relative rounded-xl overflow-hidden bg-[#f7fafc] dark:bg-[#154265]/10 border border-[#D1E3EE]/50 dark:border-[#1ECB6C]/[0.07] px-3 py-2.5">
          <div className="absolute top-0 inset-x-0 h-[2px] bg-gradient-to-r from-[#154265] to-[#154265]/50 dark:from-[#1ECB6C]/60 dark:to-[#9FEA86]/40" />
          <p className="text-[9px] font-bold uppercase tracking-wider text-[#154265]/40 dark:text-[#D1E3EE]/30 mb-1">Daily avg</p>
          <p className="text-sm font-extrabold text-[#154265] dark:text-white tabular-nums leading-none truncate">{formatAmount(dailyAvg)}</p>
        </div>
        ...
        <div className="relative rounded-xl overflow-hidden bg-[#f7fafc] dark:bg-[#154265]/10 border border-[#D1E3EE]/50 dark:border-[#1ECB6C]/[0.07] px-3 py-2.5">
          <div className={cn(
            ...
            savingsRate === null ? 'bg-[#D1E3EE]/60 dark:bg-[#154265]/40' :
            savingsRate >= 20 ? 'bg-gradient-to-r from-[#1ECB6C] to-[#9FEA86]' :
            savingsRate >= 0 ? 'bg-gradient-to-r from-[#F7D56E] to-[#F7D56E]/50' :
            'bg-gradient-to-r from-red-400 to-rose-400',
          )} />
          <p className="text-[9px] font-bold uppercase tracking-wider text-[#154265]/40 dark:text-[#D1E3EE]/30 mb-1">Saved</p>
          <p className={cn(
            'text-sm font-extrabold tabular-nums leading-none',
            savingsRate === null ? 'text-[#154265]/40 dark:text-[#D1E3EE]/30' :
            savingsRate >= 20 ? 'text-[#1ECB6C]' :
            savingsRate >= 0 ? 'text-[#F7D56E]' :
        ...
        {/* Transactions */}
        <div className="relative rounded-xl overflow-hidden bg-[#f7fafc] dark:bg-[#154265]/10 border border-[#D1E3EE]/50 dark:border-[#1ECB6C]/[0.07] px-3 py-2.5">
          <div className="absolute top-0 inset-x-0 h-[2px] bg-gradient-to-r from-[#F7D56E] to-[#F7D56E]/50" />
          <p className="text-[9px] font-bold uppercase tracking-wider text-[#154265]/40 dark:text-[#D1E3EE]/30 mb-1">Count</p>
          <p className="text-sm font-extrabold text-[#154265] dark:text-white tabular-nums leading-none">{txCount}</p>
        </div>
      </div>

      {/* Month-over-month spending insight */}
      {totalExpense > 0 && (
        <div className="flex items-center gap-3 px-3 py-3 rounded-xl bg-gradient-to-br from-[#f0f5fa] to-[#f7fafc] dark:from-[#0d1e35]/70 dark:to-[#0a1e38]/50 border border-[#D1E3EE]/60 dark:border-[#154265]/50">
          <div className="w-7 h-7 rounded-lg bg-[#154265]/8 dark:bg-[#1ECB6C]/10 flex items-center justify-center flex-shrink-0 text-[#154265]/50 dark:text-[#1ECB6C]">
            <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </svg>
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-xs font-semibold text-[#154265] dark:text-white/90 leading-tight">
            ...
            {spendDiff !== null && (
              <p className="text-[11px] mt-0.5 text-[#154265]/50 dark:text-[#D1E3EE]/40 leading-snug">
                <span className={cn(
                  'font-semibold',
                  spendDiff > 0 ? 'text-red-500 dark:text-red-400' : 'text-[#1ECB6C]',
                )}>
      ...
      {(peakDay || hasDowData || avgTxValue > 0) && (
        <div>
          <SectionHeader
            ...
            accent="bg-gradient-to-b from-[#1a5099] to-[#1ECB6C]"
            expandable
            ...
            <div className="flex flex-col gap-2">
              ...
              {peakDay && (
                <div className={ROW_CLASS}>
                  <div className="w-7 h-7 rounded-lg bg-[#F7D56E]/10 flex items-center justify-center flex-shrink-0 text-[#F7D56E]">
                    <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                    </svg>
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-xs font-semibold text-[#154265] dark:text-white/90 leading-tight">Biggest spending day</p>
                    <p className="text-[11px] text-[#154265]/40 dark:text-[#D1E3EE]/35 mt-0.5">
              ...
              {hasDowData && (
                <div className={ROW_CLASS}>
                  <div className="w-7 h-7 rounded-lg bg-[#1ECB6C]/10 flex items-center justify-center flex-shrink-0 text-[#1ECB6C]">
                    <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-xs font-semibold text-[#154265] dark:text-white/90 leading-tight">You spend most on</p>
                    <p className="text-[11px] text-[#154265]/40 dark:text-[#D1E3EE]/35 mt-0.5">{DAY_NAMES[peakDow]}s</p>
                  </div>
                  {/* Mini bar chart */}
                      ...
                      return (
                        <div
                          ...
                          className={cn(
                            ...
                            i === peakDow ? 'bg-[#1ECB6C]' : 'bg-[#D1E3EE]/60 dark:bg-[#154265]/40',
                          )}
              ...
              {avgTxValue > 0 && (
                <div className={ROW_CLASS}>
                  <div className="w-7 h-7 rounded-lg bg-[#154265]/10 dark:bg-[#D1E3EE]/10 flex items-center justify-center flex-shrink-0 text-[#154265]/60 dark:text-[#D1E3EE]/50">
                    <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-xs font-semibold text-[#154265] dark:text-white/90 leading-tight">Avg per transaction</p>
                    <p className="text-[11px] text-[#154265]/40 dark:text-[#D1E3EE]/35 mt-0.5">expenses only</p>
                  </div>
                  <span className="text-sm font-bold text-[#154265] dark:text-white tabular-nums flex-shrink-0">
      ...
      {tagBreakdown.length > 0 && (
        <div>
          <SectionHeader
            ...
            accent="bg-gradient-to-b from-[#F7D56E] to-[#F7D56E]/40"
            expandable
          ...
          {expandedSections['tags'] && (
            <div className="flex flex-col gap-1.5">
              {tagBreakdown.map(([tagKey, amount]) => {
                ...
                return (
                  <div key={tagKey} className="flex flex-col gap-1 px-3 py-2 rounded-xl bg-[#f7fafc] dark:bg-[#154265]/10 border border-[#D1E3EE]/50 dark:border-[#1ECB6C]/[0.07]">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-1.5 min-w-0">
                        {tag && (
                          <span className="w-2 h-2 rounded-full flex-shrink-0" style={{ backgroundColor: tag.color }} />
                        )}
                        <span className="text-xs font-semibold text-[#154265] dark:text-white/90 truncate">
                          {tag?.label ?? tagKey}
                        </span>
                      </div>
                      <div className="flex items-center gap-2 flex-shrink-0">
                        <span className="text-[10px] text-[#154265]/40 dark:text-[#D1E3EE]/30">{Math.round(pct * 100)}%</span>
                        <span className="text-xs font-bold text-red-500 dark:text-red-400 tabular-nums">−{formatAmount(amount)}</span>
                      </div>
                    </div>
                    <div className="h-1 rounded-full bg-[#D1E3EE]/50 dark:bg-[#154265]/30 overflow-hidden">
                      <div
                        className="h-full rounded-full transition-all duration-500"
                        style={{ width: `${pct * 100}%`, backgroundColor: tag?.color ?? '#1ECB6C' }}
                      />
                    </div>
                  </div>
                );
      ...
      {upcoming.length > 0 && (
        <div>
          <SectionHeader
            label="Next 7 days"
            accent="bg-gradient-to-b from-[#154265] to-[#1ECB6C]"
            expandable
              ...
              {upcoming.map(({ tx, date }) => (
                <div key={tx.id} className={ROW_CLASS}>
                  <div className={cn(
                    ...
                    tx.category === 'income' ? 'bg-[#1ECB6C]' : 'bg-red-400',
                  )} />
                  <div className="flex-1 min-w-0">
                    <p className="text-sm text-[#154265] dark:text-white/90 truncate font-medium leading-tight">{tx.name}</p>
                    <p className="text-[11px] text-[#154265]/40 dark:text-[#D1E3EE]/35 mt-0.5 leading-tight">
                      {new Date(date + 'T12:00:00').toLocaleDateString('en-GB', { weekday: 'short', day: 'numeric', month: 'short' })}
                    </p>
                  </div>
                  <span className={cn(
                    'text-sm font-bold tabular-nums flex-shrink-0',
                    tx.category === 'income' ? 'text-[#1ECB6C]' : 'text-red-500 dark:text-red-400',
                  )}>
      ...
      {recurringItems.length > 0 && (
        <div>
          <SectionHeader
            ...
            accent="bg-gradient-to-b from-[#1ECB6C] to-[#9FEA86]"
            expandable
            ...
            <div className="flex flex-col gap-1.5">
              {recurringItems.map((tx) => (
                <div key={tx.transaction_id} className={ROW_CLASS}>
                  <div className={cn(
                    'w-[3px] self-stretch rounded-full flex-shrink-0 min-h-[1.5rem]',
                    tx.category === 'income' ? 'bg-[#1ECB6C]' : 'bg-[#154265]/40 dark:bg-[#D1E3EE]/30',
                  )} />
                  <div className="flex-1 min-w-0">
                    <p className="text-sm text-[#154265] dark:text-white/90 truncate font-medium leading-tight">{tx.name}</p>
                    {tx.frequency && (
                      <p className="text-[11px] text-[#154265]/40 dark:text-[#D1E3EE]/35 mt-0.5 leading-tight">{FREQUENCIES[tx.frequency]}</p>
                    )}
                  </div>
                  <span className={cn(
                    'text-sm font-bold tabular-nums flex-shrink-0',
            ...
            <div className="flex flex-col gap-2">
              {goals.map((goal) => {
                ...
                const daysLeft = goal.deadline
                  ...
                  : null;
                return (
                  <div key={goal.id} className="flex flex-col gap-1.5 px-3 py-2.5 rounded-xl bg-[#f7fafc] dark:bg-[#154265]/10 border border-[#D1E3EE]/50 dark:border-[#1ECB6C]/[0.07]">
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-1.5 min-w-0">
                        {linkedTag && (
                          <div className="w-2 h-2 rounded-full flex-shrink-0" style={{ backgroundColor: linkedTag.color }} />
                        )}
                        <p className="text-sm font-medium text-[#154265] dark:text-white/90 truncate">{goal.name}</p>
                      </div>
                      <span className={cn(
                        'text-xs font-semibold tabular-nums flex-shrink-0',
                        pct >= 1 ? 'text-[#1ECB6C]' : 'text-[#154265]/50 dark:text-[#D1E3EE]/40',
                      )}>
                        {Math.round(pct * 100)}%
                      </span>
                    </div>
                    <div className="h-1.5 rounded-full bg-[#D1E3EE]/50 dark:bg-[#154265]/40 overflow-hidden">
                      <div
                        className={cn('h-full rounded-full transition-all duration-700', pct >= 1 ? 'bg-[#1ECB6C]' : 'bg-gradient-to-r from-[#1ECB6C] to-[#9FEA86]')}
                        style={{ width: `${pct * 100}%` }}
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-[11px] text-[#154265]/40 dark:text-[#D1E3EE]/35">
                      ...
                      {daysLeft !== null ? (
                        ...
                        <span className="text-[10px] text-[#154265]/30 dark:text-[#D1E3EE]/25 italic">auto</span>
                      ) : null}
                    </div>
                  </div>
                );
      ...
      {isEmpty && (
        <div className="py-12 text-center">
          <div className="w-10 h-10 rounded-full bg-[#D1E3EE]/40 dark:bg-[#154265]/20 flex items-center justify-center mx-auto mb-3">
            <svg className="w-5 h-5 text-[#154265]/30 dark:text-[#D1E3EE]/20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
            </svg>
          </div>
          <p className="text-sm font-medium text-[#154265]/35 dark:text-[#D1E3EE]/25">No transactions this month</p>
        </div>
      )}
    </div>
  );

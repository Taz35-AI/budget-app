        ...
        <>
          ...
          >
            <div className="flex items-center justify-between mb-3">
              <div>
                <p className="text-sm font-bold text-slate-900 dark:text-white">Monthly Budget</p>
                {limit && (
                  <p className="text-xs text-slate-400 dark:text-white/40">{formatAmount(monthExpense)} spent of {formatAmount(limit)}</p>
                )}
              </div>
